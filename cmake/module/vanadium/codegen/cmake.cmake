...
function(target_vanadium_cmake_codegen TARGETNAME LINK_TYPE INDIR INSTALL_FLAG )
  ...
  string(REGEX REPLACE "codegen/cmake$" "" REL_INDIR ${REL_INDIR})
  ...
  file(GLOB_RECURSE CMAKE_HEADER_LIST "${INDIR}/*.hpp.cmake.codegen")
  file(GLOB_RECURSE CMAKE_SOURCE_LIST "${INDIR}/*.cpp.cmake.codegen")
  ...
  foreach(INFILE ${CMAKE_SOURCE_LIST})
    ...
    string(REGEX REPLACE ".cmake.codegen$" "" REL_OUTFILE ${REL_INFILE})
  ...
  if(INSTALL_FLAG STREQUAL "INSTALL")
    install(
      DIRECTORY ${INC_OUTDIR}
      DESTINATION  ${CMAKE_INSTALL_PREFIX}
      )
  elseif(INSTALL_FLAG STREQUAL "BUILDONLY")
  else()
    message(FATAL_ERROR "
    Unexpected Install Flag: ${INSTALL_FLAG}
    Allowed Values: INSTALL BUILDONLY
      ")
  endif()
endfunction()
